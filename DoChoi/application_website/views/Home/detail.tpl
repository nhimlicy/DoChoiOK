							...
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<input type="text" value="{$r->number}" />
                                                                        <br/>
									<button type="button" class="btn btn-fefault cart" rel="{$r->id}">
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade active in" id="reviews" >
								...
								<div class="col-sm-12">
									...
									<ul>
										<li><a href=""><i class="fa fa-user"></i>{$c->email}</a></li>
										<li><a href=""><i class="fa fa-clock-o"></i>{$c->time}</a></li>
									...
									<p> {$c->content}</p>
                                                                    ...
                                                                    <p><b>Write Your Review</b></p>
                                                                        <form action="home/commit/{$r->id}" method="post">
										<span>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												...
												<h2>{$r->price}</h2>
												<p>{$r->name}</p>
                                                                                                <a href="#" class="btn btn-default add-to-cart" rel="{$r->id}"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
											</div>
										</div>
									</div>
